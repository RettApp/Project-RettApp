<div data-role="page" id="drugs-03-illness" data-quicklinks="true">
	...
	<div data-role="content" role="main" class="ui-content">
		<ul data-role="listview" data-filter="false" data-filter-placeholder="Medikamenten Suche..." data-inset="false">
			<li>Abdomen, akutes</li>
			<li>Anaphylaxie</li>
			<li>Apoplex</li>
			<li>Atemnot, akute</li>
			<li>Exsikkose</li>
			<li>Hypoglykämie</li>
			<li>Koronarsyndrom, akutes</li>
			<li>Krampfanfall</li>
		</ul>
	</div>
	<div data-role="footer" data-position="fixed">
		<div data-role="navbar">
			<ul>
				...
				<li><a href="#drugs-regional-01-index" data-icon="bullets">Reginal</a>
				<!--<li><a href="#drugs-03-illness" data-icon="bullets">Krankheit</a></li>-->
			</ul>
		</div>
	</div>
</div>